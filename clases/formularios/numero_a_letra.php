...
function unidad_centimos($numero)
{
    switch ($numero)
    {
        case 9:
        {
            $num_letra = "nueve centimos";
            break;
        }
        case 8:
        {
            $num_letra = "ocho centimos";
            break;
        }
        case 7:
        {
            $num_letra = "siete centimos";
            break;
        }
        case 6:
        {
            $num_letra = "seis centimos";
            break;
        }
        case 5:
        {
            $num_letra = "cinco centimos";
            break;
        }
        case 4:
        {
            $num_letra = "cuatro centimos";
            break;
        }
        case 3:
        {
            $num_letra = "tres centimos";
            break;
        }
        case 2:
        {
            $num_letra = "dos centimos";
            break;
        }
        case 1:
        {
            $num_letra = "un centimo";
            break;
        }
    }
    return $num_letra;
...
function decena_centimos($numero)
{
    if ($numero >= 10)
    {
        ...
        {
              if ($numero == 90)
                  return "noventa centimos";
              else if ($numero == 91)
                  return "noventa y un centimos";
              else
        ...
        {
            if ($numero == 80)
                return "ochenta centimos";
            else if ($numero == 81)
                return "ochenta y un centimos";
            else
        ...
        {
            if ($numero == 70)
                return "setenta centimos";
            else if ($numero == 71)
                return "setenta y un centimos";
            else
        ...
        {
            if ($numero == 60)
                return "sesenta centimos";
            else if ($numero == 61)
                return "sesenta y un centimos";
            else
        ...
        {
            if ($numero == 50)
                return "cincuenta centimos";
            else if ($numero == 51)
                return "cincuenta y un centimos";
            else
        ...
        {
            if ($numero == 40)
                return "cuarenta centimos";
            else if ($numero == 41)
                return "cuarenta y un centimos";
            else
        ...
        {
            if ($numero == 30)
                return "treinta centimos";
            else if ($numero == 91)
                return "treinta y un centimos";
            else
        ...
        {
            if ($numero == 20)
                return "veinte centimos";
            else if ($numero == 21)
                return "veintiun centimos";
            else
        ...
        {
            if ($numero == 10)
                return "diez centimos";
            else if ($numero == 11)
                return "once centimos";
            else if ($numero == 11)
                return "doce centimos";
            else if ($numero == 11)
                return "trece centimos";
            else if ($numero == 11)
                return "catorce centimos";
            else if ($numero == 11)
                return "quince centimos";
            else if ($numero == 11)
                return "dieciseis centimos";
            else if ($numero == 11)
                return "diecisiete centimos";
            else if ($numero == 11)
                return "dieciocho centimos";
            else if ($numero == 11)
                return "diecinueve centimos";
        }
    }
    else
...
function cien_mil()
{
    ...
    $importe_parcial = substr($importe_parcial, $car);
    //echo "Importe parcial:".$importe_parcial;
...
function convertir_a_letras($numero)
{
    ...
    if ($numero < 1000000000)
    {
        ...
        {
            if ($numero == 0.01)
                $num_letras = "un centimo".'----';
            else
                $num_letras = convertir_a_letras(($numero * 100)."/100")." centimos".'----';
        }
    }
    return $num_letras;
}
