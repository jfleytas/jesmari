...
function generateTableRow() {
	...
	'<td><span class="detallerow-number"><input type="number" id="costo_producto" name="costo_producto" value="<?php echo $costo_producto;?>"></span></td>'+
...
/*function currencyFormat (num, round) {
    return num
       .toFixed(round) // always two decimal digits
...
function updateInvoice() {
	...
	// =====================
		...
		total_linea = Number(detalle_cantidad * detalle_costo).toFixed(round);
		//$("#total_linea").val(currencyFormat(parseFloatHTML(total_linea),round));
		$("#total_linea").val(total_linea,round);
		//total_pedido += total_linea;
		total_pedido = Number(detalle_total_general) + Number(total_linea);
		//alert (detail_cells);
		//console.info(currencyFormat(total_linea,round))
	//}
	...
	//balance_cells[2].innerHTML = total_pedido;
